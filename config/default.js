exports.sead = {
    period: 5000, // Send period updates every 5 seconds.
    m: 15, // Maximum network diameter.
    n: 3, // Number of sequence numbers to prepare for.  (= 2^n - 1)
    pbkdf: { // PBKDF settings for keys between peers.
        salt: 'yOJFVshLUL',
        count: 1000
    },
    timeouts: { // ttl = (interval * n) + (m * period) + grace
        interval: 3000, // On what interval to push up sequence number manually.
